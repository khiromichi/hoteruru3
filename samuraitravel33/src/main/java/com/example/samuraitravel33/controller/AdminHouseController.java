...
import com.example.samuraitravel33.form.HouseEditForm;
import com.example.samuraitravel33.form.HouseRegisterForm;
import com.example.samuraitravel33.repository.HouseRepository;
import com.example.samuraitravel33.service.HouseService;
...
//    	フォワードだとブラウザのURLは変更されないがブラウザに表示される内容のみ変わる。リダイレクトだとブラウザのURLも変更してくれる。
//    	つまり、今回リダイレクトを使用することで、ユーザが遷移先の画面でリロードをした際に、再度登録処理がされないようにしてくれている。
